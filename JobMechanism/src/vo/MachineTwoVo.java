...
@Entity
@Table(name = "machinetwo")
public class MachineTwoVo {
	@Id
	...
	public MachineOneVo getMachineOneVo() {
		return machineOneVo;
	}

	public void setMachineOneVo(MachineOneVo machineOneVo) {
		this.machineOneVo = machineOneVo;
	}
