        ...
        <div class="top-bar-box pl-0 colored">
            <div class="container">
                <div class="top-bar">
                    ...
                    <div class="page-info">HOME / PRODUCTS / JOBMECHANISM / MACHINE ONE</div>
                ...
                <form action="<%= request.getContextPath()%>/AddMachineWork" method="get">
                    <div class="row">
                        ...
                        <div class="col-lg-12 row">
                        	...
                        	<div class="col-md-2">
                        		...
                        		<optgroup label="Select Product Name" data-select2-id="58">
													<c:forEach var="selectpro" items="${sessionScope.selectpro}">
														<option value="${selectpro.productId }"
															data-select2-id="1">${selectpro.productName }
														</option>
													</c:forEach>
												</optgroup>
												</select>
                        ...
                        <div class="float-right">
                        	...
                        	<input type="hidden" value="m1" name="flag">
                        </div>
                        </div>
